...
def test_strategy_initialization() -> None:
    ...
    # Run with dummy data to test init (FIXED: Use index-based datetime, no 'datetime' column)
...
def test_strategy_no_trade_low_adx() -> None:
    ...
    # Placeholder for integration test with data
    # This tests that strategy initializes with correct threshold
    config = AppConfig()
